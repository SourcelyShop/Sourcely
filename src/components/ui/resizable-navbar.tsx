...
export const NavbarMain = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-neutral-950/30",
        className,
      )}
    >
      {children}
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      " flex-row items-center justify-between bg-black text-white shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
  };
